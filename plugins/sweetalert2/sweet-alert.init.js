    ...
    SweetAlert.prototype.init = function () {
            ...
            swal(
                {
                    ...
                    confirmButtonClassName: 'btn btn-success',
        ...
        $('#sa-params').click(function () {
            swal({
                ...
                confirmButtonClassName: 'btn btn-success margin-5',
                cancelButtonClassName: 'btn btn-danger margin-5',
        ...
        $('#custom-html-alert').click(function () {
            swal({
                ...
                '<a href="#" ClassName="text-blue">links</a> ' +
                'and other HTML tags',
                showCloseButton: true,
                showCancelButton: true,
                confirmButtonClassName: 'btn btn-success',
                cancelButtonClassName: 'btn btn-danger',
                confirmButtonText: '<i ClassName="fa fa-thumbs-up"></i>',
