...
(function(global, factory) {
  ...
  function _ClassNameCallCheck(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
      throw new TypeError('Cannot call a ClassName as a function');
    }
  }

  var _createClassName = (function() {
  ...
  var hex = {
    init: function init(api) {
      var template = '<input type="text" ClassName="' + api.namespace + '-hex" />';
  ...
  var saturation = {
    defaults: {
      template: function template(namespace) {
        return '<div ClassName="' + namespace + '-saturation"><i><b></b></i></div>';
      }
    },
  ...
  var buttons = {
    defaults: {
      ...
      cancelText: null,
      template: function template(namespace) {
        return '<div ClassName="' + namespace + '-buttons"></div>';
      },
  ...
  var trigger = {
    defaults: {
      template: function template(namespace) {
        return '<div ClassName="' + namespace + '-trigger"><span></span></div>';
      }
    },
  ...
  var clear = {
    defaults: {
      template: function template(namespace) {
        return '<a href="#" ClassName="' + namespace + '-clear"></a>';
      }
    },
  ...
  var palettes = {
    defaults: {
      template: function template(namespace) {
        return '<ul ClassName="' + namespace + '-palettes"></ul>';
      },
    ...
    defaults: {
      template: function template(namespace) {
        return (
          '<ul ClassName="' +
          namespace +
          '-preview"><li ClassName="' +
          namespace +
          '-preview-current"><span /></li><li ClassName="' +
          namespace +
      ...
      markers: {
        ...
        init: function init() {
          ...
          that.$doc.on(that.api.eventName('keydown'), function(e) {
            if (that.api.opened && that.$markers.is('.' + that.ClassNamees.focus)) {
          ...
          that.$markers
            .on(that.api.eventName('focus'), function() {
              that.$markers.addClass(that.ClassNamees.focus);
            })
            .on(that.api.eventName('blur'), function() {
              that.$markers.removeClassName(that.ClassNamees.focus);
            });
        ...
        active: function active(id) {
          that.$markers.children().removeClassName(that.ClassNamees.active);

          var $marker = this.getMarker(id);
          $marker.addClass(that.ClassNamees.active);
  ...
  Gradient.prototype = {
    ...
    enable: function enable(value) {
      ...
      this.$gradient.addClass(this.ClassNamees.enable);
    ...
    disable: function disable() {
      ...
      this.$gradient.removeClassName(this.ClassNamees.enable);
  ...
  var gradient = {
    defaults: {
      ...
      template: function template() {
        var namespace = this.api.namespace;
        var control = '<div ClassName="' + namespace + '-gradient-control">';
        ...
        return (
          ...
          '<div ClassName="' +
          namespace +
          '-gradient"><div ClassName="' +
          namespace +
          '-gradient-preview"><ul ClassName="' +
          namespace +
          '-gradient-markers"></ul></div><div ClassName="' +
          namespace +
          '-gradient-wheel"><i></i></div><input ClassName="' +
          namespace +
  ...
  var AsColorPicker = (function() {
    function AsColorPicker(element, options) {
      _ClassNameCallCheck(this, AsColorPicker);
      ...
      if (this.options.hideInput) {
        this.$element.addClass(this.ClassNamees.hideInput);
      }
      ...
      [
        ...
        },
        {
          ...
          value: function init() {
            ...
            if (this.options.skin) {
              this.$dropdown.addClass(this.ClassNamees.skin);
              this.$element.parent().addClass(this.ClassNamees.skin);
            }
        ...
        },
        {
          ...
          value: function _create() {
            ...
            this.$dropdown = (0, _jquery2.default)(
              '<div ClassName="' +
                this.ClassNamees.dropdown +
                '" data-mode="' +
                this.options.mode +
                '"></div>'
            );
            this.$element
              .wrap('<div ClassName="' + this.ClassNamees.wrap + '"></div>')
              .addClass(this.ClassNamees.input);
        ...
        },
        {
          ...
          value: function open() {
            ...
            this.$mask = (0, _jquery2.default)('.' + this.ClassNamees.mask);
            ...
            this.$dropdown.addClass(this.ClassNamees.open);
        ...
        },
        {
          ...
          value: function createMask() {
            ...
            this.$mask.attr('ClassName', this.ClassNamees.mask);
            this.$mask.hide();
        ...
        },
        {
          ...
          value: function close() {
            ...
            this.$dropdown.removeClassName(this.ClassNamees.open);
        ...
        },
        {
          ...
          value: function enable() {
            this.disabled = false;
            this.$parent.addClass(this.ClassNamees.disabled);
        ...
        },
        {
          ...
          value: function disable() {
            this.disabled = true;
            this.$parent.removeClassName(this.ClassNamees.disabled);
