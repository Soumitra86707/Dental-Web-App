(function($) {
    $.fn.timeDropper = function(options, callbackFnk) {
        return $(this).each(function() {
            ...
            $('body').append('<div ClassName="td-wrap td-n2" id="td-clock-' + _td_id + '"><div ClassName="td-overlay"></div><div ClassName="td-clock td-init"><div ClassName="td-deg td-n"><div ClassName="td-select"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 35.4" enable-background="new 0 0 100 35.4" xml:space="preserve"><g><path fill="none" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M98.1,33C85.4,21.5,68.5,14.5,50,14.5S14.6,21.5,1.9,33"/><line fill="none" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="1.9" y1="33" x2="1.9" y2="28.6"/><line fill="none" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="1.9" y1="33" x2="6.3" y2="33"/><line fill="none" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="98.1" y1="33" x2="93.7" y2="33"/><line fill="none" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="98.1" y1="33" x2="98.1" y2="28.6"/></g></svg></div></div><div ClassName="td-medirian"><span ClassName="td-icon-am td-n">AM</span><span ClassName="td-icon-pm td-n">PM</span></div><div ClassName="td-lancette"><div></div><div></div></div><div ClassName="td-time"><span ClassName="on"></span>:<span></span></div></div></div>');
                    ...
                    if (t.index() == 0) {
                        ...
                        if (_td_options.meridians) {
                            ...
                            if (h >= 12 && h < 24) {
                                ...
                                _td_c.find('.td-icon-am').removeClassName('td-on');
                            } else {

                                _td_c.find('.td-icon-am').addClass('td-on');
                                _td_c.find('.td-icon-pm').removeClassName('td-on');
                            }
            ...
            _td_c.find('.td-time span').on('click', function(e) {
                ...
                _td_c.find('.td-time span').removeClassName('on');
                o.addClass('on');
            ...
            _td_c.find('.td-deg').on('touchstart mousedown', function(e) {
                ...
                _td_c.find('.td-deg').removeClassName('td-n');
                _td_c.find('.td-select').removeClassName('td-rubber');
                ...
                _td_c.removeClassName('td-rubber');
            ...
            _td_input.click(function(e) {
                ...
                _td_container.removeClassName('td-fadeout');
                ...
                if (_td_c.hasClassName('td-init')) {

                    _td_alert = setInterval(function() {
                        _td_c.find('.td-select').addClass('td-alert');
                        setTimeout(function() {
                            _td_c.find('.td-select').removeClassName('td-alert');
                        }, 1000);
                    }, 2000);

                    _td_c.removeClassName('td-init');
            ...
            _td_overlay.click(function() {
                ...
                _td_container.addClass('td-fadeout').removeClassName('td-' + _td_options.init_animation);
                _td_event = setTimeout(function() {
                    _td_container.removeClassName('td-show')
                }, 300);
