...
(function(factory) {
        ...
        extend(Pane.prototype, {
            ...
            renderBackground: function(backgroundOptions, i) {
                ...
                this.background[i][method]({
                    ...
                    'ClassName': 'highcharts-pane ' + (backgroundOptions.ClassName || '')
                });
            ...
            defaultBackgroundOptions: {
                /**
                 * The ClassName name for this background.
                 * 
                 * @type {String}
    ...
    (function(H) {
        ...
        if (!H.radialAxisExtended) {
            ...
            /**
             * Add special cases within the Tick ClassName' methods for radial axes.
             */
    ...
    (function(H) {
        ...
        /**
         * The ColumnRangeSeries ClassName
         */
        seriesType('columnrange', 'arearange', merge(
            ...
            setState: colProto.pointClassName.prototype.setState
        });
    ...
    (function(H) {
        ...
        seriesType('boxplot', 'column', {
             ...
             * `.highcharts-boxplot-box` ClassName.
             *
             * @type    {Color}
             * @sample  {highcharts} highcharts/plotoptions/box-plot-styling/
             *          Box plot styling
             ...
             * `.highcharts-boxplot-median` ClassName.
             * 
             * @type {Color}
             * @sample    {highcharts} highcharts/plotoptions/box-plot-styling/
             *            Box plot styling
            ...
            */
             ...
             * `.highcharts-boxplot-stem` ClassName.
             *
             * @type      {Color}
             * @sample    {highcharts} highcharts/plotoptions/box-plot-styling/
             *            Box plot styling
             ...
             * `.highcharts-boxplot-whisker` ClassName .
             *
             * @type      {Color}
             * @sample    {highcharts} highcharts/plotoptions/box-plot-styling/
             *            Box plot styling
    ...
    (function(H) {
        ...
        seriesType('waterfall', 'column', {
             ...
             * `.highcharts-intermediate-sum` ClassNamees.
             * 
             * @type      {Color}
             ...
             * 
             * In styled mode, the stroke can be set with the `.highcharts-graph` ClassName.
             * 
             * @type    {Color}
             * @default #333333
             * @since   3.0
