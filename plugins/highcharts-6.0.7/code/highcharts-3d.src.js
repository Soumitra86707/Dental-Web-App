...
(function(factory) {
        ...
        */
        ...
        SVGRenderer.prototype.cuboid = function(shapeArgs) {
            ...
            result.top = this.path(paths[1]).attr({
                'ClassName': 'highcharts-3d-top'
            }).add(result);
            result.side = this.path(paths[2]).attr({
                'ClassName': 'highcharts-3d-side'
            }).add(result);
        ...
        H.SVGRenderer.prototype.arc3d = function(attribs) {
            ...
            wrapper.onAdd = function() {
                var parent = wrapper.parentGroup,
                    ClassName = wrapper.attr('ClassName');
                ...
                each(['out', 'inn', 'side1', 'side2'], function(face) {
                    wrapper[face]
                        .attr({
                            'ClassName': ClassName + ' highcharts-3d-side'
                        })
                        .add(parent);
                });
            };
            ...
            // Cascade to faces
            each(['addClassName', 'removeClassName'], function(fn) {
                wrapper[fn] = function() {
                    var args = arguments;
        ...
        wrap(Chart.prototype, 'drawChartBox', function(proceed) {
            if (this.is3d()) {
                ...
                this.frameShapes.bottom[verb]({
                    'ClassName': 'highcharts-3d-frame highcharts-3d-frame-bottom',
                ...
                this.frameShapes.top[verb]({
                    'ClassName': 'highcharts-3d-frame highcharts-3d-frame-top',
                ...
                this.frameShapes.left[verb]({
                    'ClassName': 'highcharts-3d-frame highcharts-3d-frame-left',
                ...
                this.frameShapes.right[verb]({
                    'ClassName': 'highcharts-3d-frame highcharts-3d-frame-right',
                ...
                this.frameShapes.back[verb]({
                    'ClassName': 'highcharts-3d-frame highcharts-3d-frame-back',
                ...
                this.frameShapes.front[verb]({
                    'ClassName': 'highcharts-3d-frame highcharts-3d-frame-front',
    ...
    (function(H) {
        ...
        */
        ...
        var CylinderSeries = H.extendClassName(seriesTypes.column, {
        	type: 'cylinder'
        });
    ...
    (function(H) {
        ...
        wrap(seriesTypes.pie.prototype.pointClassName.prototype, 'haloPath', function(proceed) {
            var args = arguments;
