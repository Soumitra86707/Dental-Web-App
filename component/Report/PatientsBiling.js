...
import UploadExtraExpences from "./UploadPatientsBilling";
...
function ViewReport() {
  ...
  useEffect(() => {
    const fetchPatientsLabReports = () => {
      const PatientsLabReportsCollection = collection(db, "PatientsBilling");
    ...
    <div className="App">
      <div className="main-container">
        ...
        <div className="card-box pb-10">
              ...
              >
                <div style={{ textAlign: "left", fontSize: "25px", fontWeight: "bold" }}>Patients Biling History</div>
                <div className=" btn text-primary weight-500 hover:text-white " style={{ textAlign: "right", fontSize: "18px", fontWeight: "bold",cursor:"pointer"  }} onClick={() => setIsVisible(!isVisible)}><i className="ion-plus-round text-primary"></i>  Upload Patients Bill</div>
...
{/*                 <div style={{ textAlign: "left", fontSize: "18px", fontWeight: "bold" }}><div className="d-flex justify-content-between mb-2">
  ...
  <thead>
    <tr>
      <th>Serial No.</th>
      <th className="table-plus">Patient Name</th>
      <th>Item Name</th>
      <th>Payment To</th>
      <th>Total Amount</th>
      <th>Paid Amount</th>
