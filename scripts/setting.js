...
jQuery(document).ready(function () {
	...
	jQuery("img.svg").each(function () {
		...
		var imgClassName = $img.attr("ClassName");
		...
		jQuery.get(
			...
			function (data) {
				...
				if (typeof imgClassName !== "undefined") {
					$svg = $svg.attr("ClassName", imgClassName + " replaced-svg");
				}
	...
	// form-control on focus add ClassName
	$(".form-control").on("focus", function () {
		$(this).parent().addClass("focus");
	});
	$(".form-control").on("focusout", function () {
		$(this).parent().removeClassName("focus");
	});
	...
	$(document).on("touchstart click", function (e) {
		if (
			...
			$(".left-side-bar").removeClassName("open");
			$(".menu-icon").removeClassName("open");
			$(".mobile-menu-overlay").removeClassName("show");
		}
	});
	...
	$.fn.vmenuModule = function (option) {
		...
		item.unbind("click").on("click", function () {
			...
			if (options.autohide) {
				a.parent()
					...
					.slideUp(options.Speed / 1.2, function () {
						...
						$(this).parent("li").removeClassName("show");
					});
			}
			...
			if (a.attr("data-option") == "on") {
				...
				a.parent("li").removeClassName("show");
			}
		});
